...
export function userProfilesFetchIdSuccess(payload){
    return{
        type:"userprofiles/getById",
        payload
    }
}
...
export const fetchUserProfileId = (id) =>{
    return async(dispatch)=>{
        try {
            ...
            const action = userProfilesFetchIdSuccess(data)
            dispatch(action)
